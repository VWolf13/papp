...
{				
	...
	/*#app*/ this._1 = function() { return _map; }
	/*#app*/ this._2 = function(){ return _started; }
	...
	/*#app*/ this._7 = function( js ) { prompt( "#", "App.Execute("+js ); } 
	/*#app*/ this._8 = function( file,options,intent ) { prompt( "#", "App.StartApp(\f"+file+"\f"+options+"\f"+intent ); }
	/*#app*/ this._9 = function( name ) { prompt( "#", "App.StopApp("+name ); }
	/*#app*/ this._10 = function( mode ) { prompt( "#", "App.SetScreenMode(\f"+mode ); }
	/*#app*/ this._11 = function( options ) { prompt( "#", "App.SetOptions(\f"+options ); }
	/*#app*/ this._12 = function( theme ) { prompt( "#", "App.SetTheme(\f"+(theme?theme.id:null) ); }
	/*#app*/ this._13 = function( dpi ) { prompt( "#", "App.SetDensity(\f"+dpi ); }
	/*#app*/ this._14 = function( left,top,width,height,options ) { prompt( "#", "App.SetPosition(\f"+left+"\f"+top+"\f"+width+"\f"+height+"\f"+options ); }
	/*#app*/ this._15 = function( clr ) { prompt( "#", "App.SetBackColor(\f"+clr ); }  
	...
	/*#app*/ this._16 = function( packageName,className ) { prompt( "#", "App.StartService(\f"+packageName+"\f"+className ); }
	/*#app*/ this._17 = function() { prompt( "#", "App.StopService(" ); }
	/*#app*/ this._18 = function() { prompt( "#", "App.StartDebugServer(" ); }
	/*#app*/ this._19 = function() { prompt( "#", "App.StopDebugServer(" ); }
	/*#app*/ this._20 = function( packageName,className,action,category,uri,type,extras,options,callback ) { prompt( "#", "App.SendIntent(\f"+packageName+"\f"+className+"\f"+action+"\f"+category+"\f"+uri+"\f"+type+"\f"+extras+"\f"+options+"\f"+_Cbm(callback) ); }
	/*#app*/ this._21 = function( action,category,data,type,extras,options ) { prompt( "#", "App.BroadcastIntent(\f"+action+"\f"+category+"\f"+data+"\f"+type+"\f"+extras+"\f"+options ); }
	/*#app*/ this._22 = function( msg ) { prompt( "#", "App.SendMessage(\f"+msg ); }
	/*#app*/ this._23 = function( title,text,largeIcon,smallIcon,importance ) { prompt( "#", "App.SetInForeground(\f"+title+"\f"+text+"\f"+largeIcon+"\f"+smallIcon+"\f"+importance ); }
	/*#app*/ this._24 = function() { prompt( "#", "App.SetInBackground(\f" ); }
	/*#app*/ this._25 = function( file ) { _LoadScriptSync( file ); }
	/*#app*/ this._26 = function( url, callback ) { _LoadScript( url, callback ); }
	/*#app*/ this._27 = function( url ) { _LoadPlugin( url ); }
	/*#app*/ this._28 = function( cmd,options,maxRead,timeout ) { return prompt( "#", "App.SysExec(\f"+cmd+"\f"+options+"\f"+maxRead+"\f"+timeout ); } 
	/*#app*/ this._29 = function( name,file,args,options ) { return prompt( "#", "App.ExtExec(\f"+name+"\f"+file+"\f"+args+"\f"+options ); } 
	/*#app*/ this._30 = function( level ) { prompt( "#", "App.SetPriority(\f"+level ); } 
	/*#app*/ //this.Odroid = function( p1,p2,p3 ) { return prompt( "#", "App.Odroid(\f"+p1+"\f"+p2+"\f"+p3 ); }
	/*#app*/ this._31 = function() { return prompt( "#", "App.GetName(" ); }
	/*#app*/ this._32 = function() { return prompt( "#", "App.GetPath(" ); }
	/*#app*/ this._33 = function() { return prompt( "#", "App.GetAppName(" ); }
	/*#app*/ this._34 = function() { return prompt( "#", "App.GetAppPath(" ); }
	/*#app*/ this._35 = function() { return parseFloat(prompt( "#", "App.GetVersion(" )); }
	/*#app*/ this._36 = function() { return parseFloat(prompt( "#", "App.GetDSVersion(" )); }	
	/*#app*/ this._37 = function() { return prompt( "#", "App.IsNewVersion(" )=="true"; }
	/*#app*/ this._38 = function() { return prompt( "#", "App.InIDE(" )=="true"; }	
	/*#app*/ this._39 = function() { return prompt( "#", "App.IsAPK(" )=="true"; }	
	/*#app*/ this._40 = function() { return prompt( "#", "App.IsService(" )=="true"; }	
	/*#app*/ this._41 = function() { return prompt( "#", "App.IsPremium(" )=="true"; }	
	/*#app*/ this._42 = function() { return prompt( "#", "App.IsEngine(" )=="true"; }	
	/*#app*/ this._43 = function() { return prompt( "#", "App.GetPackageName(" ); }
	/*#app*/ this._44 = function( key ) { prompt( "#", "App.CheckLicense(\f"+key ); }
	/*#app*/ this._45 = function() { return prompt( "#", "App.GetAccounts(" ); }
	/*#app*/ this._46 = function() { return prompt( "#", "App.GetUser(" ); }
	/*#app*/ this._47 = function() { return prompt( "#", "App.GetDeviceId(" ); }
	/*#app*/ this._48 = function() { return prompt( "#", "App.GetCountryCode(" ); }
	/*#app*/ this._49 = function() { return prompt( "#", "App.GetLanguageCode(" ); }
	/*#app*/ this._50 = function() { return prompt( "#", "App.GetCountry(" ); }
	/*#app*/ this._51 = function() { return prompt( "#", "App.GetLanguage(" ); }
	/*#app*/ this._52 = function() { return prompt( "#", "App.GetOptions(" ); }	
	/*#app*/ this._53 = function( index ) { return prompt( "#", "App.GetSharedText("+index ); }
	/*#app*/ this._54 = function() { var s = prompt( "#", "App.GetSharedFiles(" ); if(s.length) return s.split(","); else return null; }
	/*#app*/ this._55 = function() { return eval(prompt( "#", "App.GetActivities(" )); }
	/*#app*/ this._56 = function( packageName ) { return prompt( "#", "App.IsAppInstalled(\f"+packageName )=="true"; }	
	/*#app*/ this._57 = function() { return eval(prompt( "#", "App.GetInstalledApps(\f" )); }
	/*#app*/ this._58 = function() { return eval(prompt( "#", "App.GetRunningApps(\f" )); }
	/*#app*/ this._59 = function() { return eval(prompt( "#", "App.GetRunningServices(\f" )); }
	/*#app*/ this._60 = function() { return eval(prompt( "#", "App.GetMemoryInfo(\f" )); }
	/*#app*/ this._61 = function() { var s = prompt( "#", "App.GetIntent(" ); if(s.length) return JSON.parse(s); else return null; }
	/*#app*/ this._62 = function() { return prompt( "#", "App.GetNotifyId(" ); }
	/*#app*/ this._63 = function( name ) { prompt( "#", "App.SetSharedApp("+name ); }
	/*#app*/ this._64 = function( appName,ext ) { return prompt( "#", "App.GetMediaFile(\f"+appName+"\f"+ext ); }
	/*#app*/ this._65 = function( procId ) { prompt( "#", "App.KillApp("+procId ); }
	/*#app*/ this._66 = function( name,iconFile,file,options ) { prompt( "#", "App.CreateShortcut(\f"+name+"\f"+iconFile+"\f"+file+"\f"+options ); }
	/*#app*/ this._67 = function() { return parseInt( prompt( "#", "App.GetBuildNum(" )); }	
	/*#app*/ this._68 = function() { return parseInt( prompt( "#", "App.GetBuildNum(" )); }	
	/*#app*/ this._69 = function() { return prompt( "#", "App.GetModel(" ); }	
	/*#app*/ this._70 = function() { return prompt( "#", "App.IsTablet(" )=="true"; }	
	/*#app*/ this._71 = function() { return prompt( "#", "App.IsChrome(" )=="true"; }	
	/*#app*/ this._72 = function() { return prompt( "#", "App.IsThings(" )=="true"; }	
	/*#app*/ this._73 = function( callback ) { prompt( "#", "App.SetOnError(\f"+_Cbm(callback) ); }
	/*#app*/ this._74 = function( callback ) { prompt( "#", "App.SetOnDebug(\f"+_Cbm(callback) ); }
	/*#app*/ this._75 = function( callback ) { prompt( "#", "App.SetOnKey(\f"+_Cbm(callback) ); }
	/*#app*/ this._76 = function( callback ) { prompt( "#", "App.SetOnShowKeyboard(\f"+_Cbm(callback) ); }
	/*#app*/ this._77 = function( callback ) { prompt( "#", "App.SetOnWifiChange(\f"+_Cbm(callback) ); }
	/*#app*/ this._78 = function( callback,options ) { prompt( "#", "App.WifiScan(\f"+_Cbm(callback)+"\f"+options ); }
	/*#app*/ this._79 = function( keyList ) { prompt( "#", "App.DisableKeys(\f"+keyList ); }
	/*#app*/ this._80 = function( disable ) { prompt( "#", "App.DisableTouch(\f"+disable ); }
	/*#app*/ this._81 = function() { return prompt( "#", "App.GetIPAddress(" ); }
	/*#app*/ this._82 = function() { return prompt( "#", "App.GetMacAddress(" ); }
	/*#app*/ this._83 = function() { return prompt( "#", "App.GetSSID(" ); }
	/*#app*/ this._84 = function() { return parseInt(prompt( "#", "App.GetRSSI(" )); }
	/*#app*/ this._85 = function( type,msg ) { prompt( "#", "App.Broadcast("+type+"\f"+msg ); }
	/*#app*/ this._86 = function( callback ) { prompt( "#", "App.SetOnBroadcast("+_Cbm(callback) ); }
	/*#app*/ this._87 = function( name,value ) { prompt( "#", "App.SetData(\f"+name+"\f"+value ); }
	/*#app*/ this._88 = function( name ) { return prompt( "#", "App.GetData(\f"+name ); }	
	/*#app*/ this._89 = function( txt ) { prompt( "#", "App.SetClipboardText("+txt ); }
	/*#app*/ this._90 = function() { return prompt( "#", "App.GetClipboardText(" ); }
	/*#app*/ this._91 = function( enable ) { prompt( "#", "App.EnableBackKey("+enable ); }		
	/*#app*/ this._92 = function( secs ) { prompt( "#", "App.Wait("+secs ); }
	/*#app*/ this._93 = function( msg,title,options,hue ) { prompt( "#", "App.Alert(\f"+msg+"\f"+title+"\f"+options+"\f"+hue ); }
	/*#app*/ this._94 = function() { prompt( "#", "App.HideKeyboard(" ); }
	/*#app*/ this._95 = function( obj ) { return prompt( "#", "App.ShowKeyboard(\f"+obj.id )=="true"; }
	/*#app*/ this._96 = function() { return prompt( "#", "App.IsKeyboardShown(" )=="true"; }
	/*#app*/ this._97 = function() { return parseInt(prompt( "#", "App.GetKeyboardHeight(" )); }
	/*#app*/ this._98 = function( text,pitch,rate,callback,stream,locale,engine ) { prompt( "#", "App.TextToSpeech(\f"+text+"\f"+pitch+"\f"+rate+"\f"+_Cbm(callback)+"\f"+stream+"\f"+locale+"\f"+engine ); }
	/*#app*/ this._99 = function( msg ) { prompt( "#", "App.Debug(\f"+msg ); }
	/*#app*/ this._100 = function( msg,line,file,quit ) { prompt( "#", "App.Error(\f"+msg+"\f"+line+"\f"+file+"\f"+quit ); }
	/*#app*/ this._101 = function( enable ) { prompt( "#", "_UseDbg(\f"+enable ); _dbg=enable; }
	/*#app*/ this._102 = function( switches ) { prompt( "#", "_UseDbg(\f"+switches ); _dbg=switches; }
	/*#app*/ this._103 = function() { return _dbg?true:false; }
	/*#app*/ this._104 = function() { return prompt( "#", "App.IsDebugging(" )=="true"; }
	/*#app*/ this._105 = function() { prompt( "#", "App.CreateDebug(" ); }
	/*#app*/ this._106 = function( show ) { prompt( "#", "App.ShowDebug("+show ); }
	/*#app*/ this._107 = function( address,subject,body,attach,type,options ) { prompt( "#", "App.SendMail(\f"+address+"\f"+subject+"\f"+body+"\f"+attach+"\f"+type+"\f"+options ); }		
	/*#app*/ this._108 = function( file,subject,text,choose ) { prompt( "#", "App.SendFile(\f"+file+"\f"+subject+"\f"+text+"\f"+choose ); }		
	/*#app*/ this._109 = function( text,subject,choose ) { prompt( "#", "App.SendText(\f"+text+"\f"+subject+"\f"+choose ); }		
	/*#app*/ this._110 = function( file,choose ) { prompt( "#", "App.SendImage(\f"+file+"\f"+choose ); }		
	/*#app*/ this._111 = function( msg,number ){ app._20(null,null,"android.intent.action.SENDTO",null,'smsto:'+number,null,JSON.stringify([{name:"sms_body",type:"string",value:msg}])); }
	// this._Extract = function( p1 ) { prompt( "#", "App._Extract("+p1 ); }
	/*#app*/ this._112 = function( src,dest,overwrite,options ) { prompt( "#", "App.ExtractAssets(\f"+src+"\f"+dest+"\f"+overwrite+"\f"+options ); }
	/*#app*/ this.RedirectAssets = function( dir ) { prompt( "#", "App.RedirectAssets(\f"+dir ); } 
	/*#app*/ this._113 = function() { prompt( "#", "App.ExtractPlugins(\f" ); }
	/*#app*/ this._114 = function( name,options ) { return parseInt(prompt( "#", "App.GetResourceId(\f"+name+"\f"+options )); }	
	/*#app*/ this._115 = function( pattern ) { prompt( "#", "App.Vibrate("+pattern ); }
	/*#app*/ this._116 = function( msg,options ) { prompt( "#", "App.ShowPopup("+msg+"\f"+options ); }
	/*#app*/ this._117 = function( msg,options ) { prompt( "#", "App.ShowProgress(\f"+msg+"\f"+options ); }	
	/*#app*/ this._118 = function() { prompt( "#", "App.HideProgress(" ); }	
	/*#app*/ this._119 = function( title,percent,options ) { prompt( "#", "App.ShowProgressBar(\f"+title+"\f"+percent+"\f"+options ); }	
	/*#app*/ this._120 = function( percent ) { prompt( "#", "App.UpdateProgressBar(\f"+percent ); }	
	/*#app*/ this._121 = function() { prompt( "#", "App.HideProgressBar(" ); }	
	/*#app*/ this._122 = function( name,dflt,file ) { return prompt( "#", "App.LoadText("+name+"\f"+dflt+"\f"+file ); }
	/*#app*/ this._123 = function( name,dflt,file ) { return parseFloat(prompt( "#", "App.LoadNumber("+name+"\f"+dflt+"\f"+file )); }	
	/*#app*/ this._124 = function( name,dflt,file ) { return (prompt( "#", "App.LoadBoolean("+name+"\f"+dflt+"\f"+file )=="true"); }
	/*#app*/ this._125 = function( name,value,file ) { prompt( "#", "App.SaveText("+name+"\f"+value+"\f"+file ); }
	/*#app*/ this._126 = function( name,value,file ) { prompt( "#", "App.SaveNumber("+name+"\f"+value+"\f"+file ); }	
	/*#app*/ this._127 = function( name,value,file ) { prompt( "#", "App.SaveBoolean("+name+"\f"+value+"\f"+file ); }	
	/*#app*/ this._128 = function( file ) { prompt( "#", "App.ClearData(\f"+file ); }
	/*#app*/ this._129 = function( name,file ) { prompt( "#", "App.ClearValue(\f"+name+"\f"+file ); }
	/*#app*/ this._130 = function() { return parseFloat(prompt( "#", "App.GetTop(" )); }
	/*#app*/ this._131 = function() { return prompt( "#", "App.HasSoftNav(" )=="true"; }
	/*#app*/ this._132 = function() { return prompt( "#", "App.IsNavBarOnRight(" )=="true"; }
	/*#app*/ this._133 = function( options ) { return parseFloat(prompt( "#", "App.GetScreenWidth(\f"+options )); }
	/*#app*/ this._134 = function( options ) { return parseFloat(prompt( "#", "App.GetScreenHeight(\f"+options )); }
	/*#app*/ this._135 = function() { return parseFloat(prompt( "#", "App.GetScreenDensity(" )); }
	/*#app*/ this._136 = function() { return parseFloat(prompt( "#", "App.GetDisplayWidth(" )); }
	/*#app*/ this._137 = function() { return parseFloat(prompt( "#", "App.GetDisplayHeight(" )); }
	/*#app*/ this._138 = function() { return prompt( "#", "App.GetDefaultOrientation(" ); }	
	/*#app*/ this._139 = function() { return prompt( "#", "App.GetOrientation(" ); }	
	/*#app*/ this.IsPortrait = function() { return prompt( "#", "App.GetOrientation(" )=="Portrait"; }	
	/*#app*/ this._140 = function( orient,callback ) { prompt( "#", "App.SetOrientation(\f"+orient+"\f"+_Cbm(callback) ); }	
	/*#app*/ this._141 = function() { return parseInt(prompt( "#", "App.GetRotation(" )); }	
	/*#app*/ this._142 = function() { return parseFloat(prompt( "#", "App.GetBatteryLevel(\f" )); }
	/*#app*/ this._143 = function() { return prompt( "#", "App.IsCharging(" )=="true"; }
	/*#app*/ this._144 = function() { return prompt( "#", "App.GetChargeType(\f" ); }
	/*#app*/ this._145 = function( mode ) { prompt( "#", "App.PreventScreenLock("+mode ); }	
	/*#app*/ this._146 = function() { prompt( "#", "App.PreventWifiSleep(" ); }
	/*#app*/ this._147 = function( enable ) { prompt( "#", "App.SetWifiEnabled(\f"+enable ); }
	/*#app*/ this._148 = function() { return prompt( "#", "App.IsWifiEnabled(" )=="true"; }
	/*#app*/ this._149 = function( enable,ssid,key ) { prompt( "#", "App.SetWifiApEnabled(\f"+enable+"\f"+ssid+"\f"+key ); }
	/*#app*/ this._150 = function() { return prompt( "#", "App.IsWifiApEnabled(" )=="true"; }
	/*#app*/ this._151 = function( ssid,key ) { prompt( "#", "App.WifiConnect(\f"+ssid+"\f"+key ); }
	/*#app*/ this._152 = function() { return prompt( "#", "App.IsConnected(" )=="true"; }
	/*#app*/ this._153 = function( enable ) { prompt( "#", "App.SetBluetoothEnabled(\f"+enable ); }
	/*#app*/ this._154 = function() { return prompt( "#", "App.IsBluetoothEnabled(" )=="true"; }
	/*#app*/ this._155 = function() { return eval(prompt( "#", "App.GetPairedBTDevices(\f" )); }
	/*#app*/ this._156 = function( name ) { return prompt( "#", "App.IsBtDevicePaired(\f"+name )=="true"; } 
	/*#app*/ this._157 = function( filter,onFound,onComplete ) { prompt( "#", "App.DiscoverBtDevices(\f"+filter+"\f"+_Cbm(onFound)+"\f"+_Cbm(onComplete) ); }
	/*#app*/ this._158 = function( address,callback ) { prompt( "#", "App.PairBtDevice(\f"+address+"\f"+_Cbm(callback) ); }
	/*#app*/ this._159 = function( address,callback ) { prompt( "#", "App.UnpairBtDevice(\f"+address+"\f"+_Cbm(callback) ); }
	/*#app*/ this._160 = function( type ) { return prompt( "#", "App.GetBtProfileState(\f"+type ); }
	/*#app*/ this._161 = function() { return prompt( "#", "App.GetBluetoothName(" ); }	
	/*#app*/ this._162 = function() { return prompt( "#", "App.GetBluetoothAddress(" ); }	
	/*#app*/ this._163 = function( types ) { return prompt( "#", "App.IsLocationEnabled(\f"+types )=="true"; }
	/*#app*/ this._164 = function( lat,lng,accuracy,speed ) { prompt( "#", "App.SetMockLocation(\f"+lat+"\f"+lng+"\f"+accuracy+"\f"+speed ); }
	/*#app*/ this._165 = function( type ) { prompt( "#", "App.PlayRingtone(\f"+type ); }
	/*#app*/ this._166 = function( mode ) { prompt( "#", "App.SetRingerMode(\f"+mode ); }
	/*#app*/ this._167 = function() { return prompt( "#", "App.GetRingerMode(" ); }
	/*#app*/ this._168 = function( on ) { prompt( "#", "App.SetSpeakerPhone(\f"+on ); }
	/*#app*/ this._169 = function() { return prompt( "#", "App.GetSpeakerPhone(" )=="true"; }
	/*#app*/ this._170 = function( stream,level,options ) { prompt( "#", "App.SetVolume(\f"+stream+"\f"+level+"\f"+options ); }
	/*#app*/ this._171 = function( stream ) { return parseFloat(prompt( "#", "App.GetVolume(\f"+stream )); }
	/*#app*/ this._172 = function( title ) { prompt( "#", "App.SetTitle("+title ); }	
	/*#app*/ this._173 = function( list,iconPath ) { prompt( "#", "App.SetMenu("+list+"\f"+iconPath ); }
	/*#app*/ this._174 = function() { prompt( "#", "App.ShowMenu(" ); }		
	/*#app*/ this._175 = function( cancel,ok ) { prompt( "#", "App.Translate(\f"+cancel+"\f"+ok ); }	
	/*#app*/ this._176 = function( layout ) { prompt( "#", "App.AddLayout("+layout.id ); }	
	/*#app*/ this._177 = function( layout ) { prompt( "#", "App.RemoveLayout("+ layout.id ); }
	/*#app*/ this._178 = function( layout ) { prompt( "#", "App.DestroyLayout("+ layout.id ); }	
	/*#app*/ this._179 = function( layout,side,width,grabWidth ) { prompt( "#", "App.AddDrawer(\f"+layout.id+"\f"+side+"\f"+width+"\f"+grabWidth ); }	
	/*#app*/ this._180 = function( side ) { prompt( "#", "App.RemoveDrawer(\f"+ side ); }
	/*#app*/ this._181 = function( side ) { prompt( "#", "App.OpenDrawer(\f"+side ); }	
	/*#app*/ this._182 = function( side ) { prompt( "#", "App.CloseDrawer(\f"+side ); }	
	/*#app*/ this._183 = function( side ) { prompt( "#", "App.LockDrawer(\f"+side ); }	
	/*#app*/ this._184 = function( side ) { prompt( "#", "App.UnlockDrawer(\f"+side ); }	
	/*#app*/ this._185 = function( side ) { return prompt( "#", "App.GetDrawerState(\f"+side ); }
	/*#app*/ this._186 = function( fldr ) { prompt( "#", "App.MakeFolder("+fldr ); }	
	/*#app*/ this._187 = function( name ) { return prompt( "#", "App.GetPrivateFolder(\f"+name ); }	
	/*#app*/ this._188 = function() { return prompt( "#", "App.GetDatabaseFolder(" ); }
	/*#app*/ this._189 = function( name ) { prompt( "#", "App.DeleteDatabase(\f"+name); }
	/*#app*/ this._190 = function( fldr ) { return prompt( "#", "App.FolderExists("+fldr )=="true"; }
	/*#app*/ this._191 = function( file ) { return prompt( "#", "App.FileExists("+file )=="true"; }
	/*#app*/ this._192 = function( fldr ) { return prompt( "#", "App.IsFolder("+fldr )=="true"; }
	/*#app*/ this._193 = function( path,filter,limit,options ) { return eval(prompt( "#", "App.ListFolder(\f"+path+"\f"+filter+"\f"+limit+"\f"+options )); }
	/*#app*/ this._194 = function() { return prompt( "#", "App.GetExternalFolder(" ); }
	/*#app*/ this._195 = function() { return prompt( "#", "App.GetInternalFolder(" ); }
	/*#app*/ this._196 = function( name ) { return prompt( "#", "App.GetSpecialFolder(\f"+name ); }
	/*#app*/ this._197 = function( name ) { return prompt( "#", "App.GetEnv(\f"+name ); }
	/*#app*/ this._198 = function( type,callback ) { prompt( "#", "App.GetPermission(\f"+type+"\f"+_Cbm(callback) ); }
	/*#app*/ this._199 = function( type ) { return prompt( "#", "App.CheckPermission(\f"+type ); }
	/*#app*/ this._200 = function( file,encoding ) { return prompt( "#", "App.ReadFile(\f"+file+"\f"+encoding ); }
	/*#app*/ this._201 = function( file,text,mode,encoding ) { prompt( "#", "App.WriteFile(\f"+file+"\f"+text+"\f"+mode+"\f"+encoding ); }	
	/*#app*/ this._202 = function( file,type,choose ) { prompt( "#", "App.OpenFile(\f"+file+"\f"+type+"\f"+choose ); }	
	/*#app*/ this._203 = function( url,type,choose ) { prompt( "#", "App.OpenUrl(\f"+url+"\f"+type+"\f"+choose ); }
	/*#app*/ this._204 = function( src,dest,title,desc,options ) { prompt( "#", "App.DownloadFile(\f"+src+"\f"+dest+"\f"+title+"\f"+desc+"\f"+options ); }
	/*#app*/ this._205 = function( msg,type,callback,fldr ) { prompt( "#", "App.ChooseFile(\f"+msg+"\f"+type+"\f"+_Cbm(callback)+"\f"+fldr ); }
	/*#app*/ this._206 = function( type,callback ) { prompt( "#", "App.ChooseContact(\f"+type+"\f"+_Cbm(callback) ); }
	/*#app*/ this._207 = function( options,callback ) { prompt( "#", "App.ChooseImage(\f"+options+"\f"+_Cbm(callback) ); }
	/*#app*/ this._208 = function( callback ) { prompt( "#", "App.ChooseAccount(\f"+_Cbm(callback) ); }
	/*#app*/ this._209 = function( file ) { prompt( "#", "App.DeleteFile("+file); }
	/*#app*/ this._210 = function( src,dest ) { prompt( "#", "App.CopyFile("+src+"\f"+dest); }
	/*#app*/ this._211 = function( src,dest,overwrite,filter ) { prompt( "#", "App.CopyFolder(\f"+src+"\f"+dest+"\f"+overwrite+"\f"+filter); }
	/*#app*/ this._212 = function( fldr ) { prompt( "#", "App.DeleteFolder("+fldr); }
	/*#app*/ this._213 = function( src,dest ) { prompt( "#", "App.RenameFile(\f"+src+"\f"+dest); }
	/*#app*/ this._214 = function( src,dest ) { prompt( "#", "App.RenameFile(\f"+src+"\f"+dest); }
	/*#app*/ this._215 = function( file,txt,rep,options ) { prompt( "#", "App.ReplaceInFile(\f"+file+"\f"+txt+"\f"+rep+"\f"+options); }
	/*#app*/ this._216 = function( src,dest ) { prompt( "#", "App.UnzipFile(\f"+src+"\f"+dest); }
	/*#app*/ this._217 = function( src,dest ) { prompt( "#", "App.ZipFile(\f"+src+"\f"+dest); }
	/*#app*/ this._218 = function( src,dest ) { prompt( "#", "App.ZipFile(\f"+src+"\f"+dest); }
	/*#app*/ this._219 = function( mode ) { return parseFloat(prompt( "#", "App.GetFreeSpace(\f"+mode)); }
	/*#app*/ this._220 = function( file ) { var d = parseInt(prompt( "#", "App.GetFileDate(\f"+file)); if( d ) return new Date(d); else return null; }
	/*#app*/ this._221 = function( file ) { return parseInt(prompt( "#", "App.GetFileSize(\f"+file)); }
	/*#app*/ this._222 = function( src,dest,width,height ) { prompt( "#", "App.GetThumbnail(\f"+src+"\f"+dest+"\f"+width+"\f"+height); }
	/*#app*/ this._223 = function( file ) { prompt( "#", "App.ScanFile(\f"+file); }
	/*#app*/ this._224 = function() { var ret = prompt( "#", "App.GetLastButton(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._225 = function() { var ret = prompt( "#", "App.GetLastToggle(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._226 = function() { var ret = prompt( "#", "App.GetLastCheckBox(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._227 = function() { var ret = prompt( "#", "App.GetLastImage(" ); if( ret ) return (_map[ret]); else return null; }
	/*#app*/ this._228 = function() { return prompt( "#", "App.IsBluetoothOn(" )=="true"; }
	/*#app*/ this._229 = function() { return prompt( "#", "App.IsScreenOn(" )=="true"; }
	/*#app*/ this._230 = function() { prompt( "#", "App.WakeUp(" ); }
	/*#app*/ this._231 = function() { prompt( "#", "App.GoToSleep(" ); }
	/*#app*/ this._232 = function() { prompt( "#", "App.Unlock(" ); }	
	/*#app*/ this._233 = function() { prompt( "#", "App.Lock(" ); }	
	/*#app*/ this._234 = function( level ) { prompt( "#", "App.SetScreenBrightness(\f"+level); }
	/*#app*/ this._235 = function( mode,enable,options ) { prompt( "#", "App.SetKioskMode(\f"+mode+"\f"+enable+"\f"+options); }
	/*#app*/ this._236 = function( file,keys ) { return prompt( "#", "App.GetMetadata(\f"+file+"\f"+keys); }
	/*#app*/ this._237 = function( type,id,callback,time,interval,options ) { return prompt( "#", "App.SetAlarm(\f"+type+"\f"+id+"\f"+_Cbm(callback)+"\f"+time+"\f"+interval+"\f"+options); }
	/*#app*/ this._238 = function( number ) { prompt( "#", "App.Call(\f"+number ); }
	/*#app*/ this._239 = function( obj,x,y,dir ) { prompt( "#", "App.SimulateTouch(\f"+obj.id+"\f"+x+"\f"+y+"\f"+dir ); }
	/*#app*/ this._240 = function( obj,x1,y1,x2,y2,step,pause ) { prompt( "#", "App.SimulateDrag(\f"+obj.id+"\f"+x1+"\f"+y1+"\f"+x2+"\f"+y2+"\f"+step+"\f"+pause ); }
	/*#app*/ this._241 = function( obj,x,y,dx,dy,count,fling ) { prompt( "#", "App.SimulateScroll(\f"+obj.id+"\f"+x+"\f"+y+"\f"+dx+"\f"+dy+"\f"+count+"\f"+fling ); }
	/*#app*/ this._242 = function( obj,keyName,modifiers,pause ) { prompt( "#", "App.SimulateKey(\f"+obj.id+"\f"+keyName+"\f"+modifiers+"\f"+pause ); }
	/*#app*/ this._243 = function( id,key ) { return parseFloat(prompt( "#", "App.GetJoyState(\f"+id+"\f"+key)); }
	/*#app*/ this._244 = function( id ) { return prompt( "#", "App.GetJoyName(\f"+id); }
	/*#app*/ this._245 = function( options ) { prompt( "#", "App.SetJoystickOptions(\f"+options ); }
	/*#app*/ this._246 = function( auto ) { prompt( "#", "App.SetAutoBoot(\f"+auto); }
	/*#app*/ this._247 = function( auto ) { prompt( "#", "App.SetAutoWifi(\f"+auto); }
	/*#app*/ this._248 = function( appName ) { prompt( "#", "App.SetAutoStart(\f"+appName); }
	/*#app*/ this._249 = function( type,baseUrl,path,params,callback,headers ) { prompt( "#", "App.HttpRequest(\f"+type+"\f"+baseUrl+"\f"+path+"\f"+params+"\f"+_Cbm(callback)+"\f"+headers); }
	/*#app*/ this._250 = function( url,file,name,callback ) { prompt( "#", "App.UploadFile(\f"+url+"\f"+file+"\f"+name+"\f"+_Cbm(callback) ); }
	/*#app*/ this._251 = function() { prompt( "#", "App.SaveCookies(" ); }	
	/*#app*/ this._252 = function( session ) { prompt( "#", "App.ClearCookies(\f"+session ); }
	/*#app*/ this._253 = function( agent ) { prompt( "#", "App.SetUserAgent(\f"+agent ); } 
    /*#app*/ this._254 = function( name,password ) { prompt( "#", "App.SetUserCreds(\f"+name+"\f"+password ); }
    /*#app*/ this._255 = function( uri,columns,select,args,sort ) { return eval(prompt( "#", "App.QueryContent(\f"+uri+"\f"+columns+"\f"+select+"\f"+args+"\f"+sort)); }
	/*#app*/ this._256 = function( uri ) { return prompt( "#", "App.Uri2Path(\f"+uri); }
	/*#app*/ this._257 = function( fileName,quality ) { prompt( "#", "App.ScreenShot(\f"+fileName+"\f"+quality ); }
	/*#app*/ this._258 = function( packageName,className ) { prompt( "#", "App.InstallWallpaper\f"+packageName+"\f"+className ); }
	
	//These objects auto-release when layout is destroyed.		
	/*#app*/ this._259 = function( type,options ) { var ret = prompt( "#", "App.CreateLayout("+type+"\f"+options ); if( ret ) return new Lay(ret); else return null; }	
	/*#app*/ this._260 = function( file,width,height,options,w,h ) { var ret = prompt( "#", "App.CreateImage("+file+"\f"+width+"\f"+height+"\f"+options+"\f"+w+"\f"+h );  if( ret ) return new Img(ret); else return null; }	
	/*#app*/ this._261 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateButton("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Btn(ret); else return null;  }		
	/*#app*/ this._262 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateToggle("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Tgl(ret); else return null;  }		
	/*#app*/ this._263 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateCheckBox("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Chk(ret); else return null;  }		
	/*#app*/ this._264 = function( list,width,height,options ) { var ret = prompt( "#", "App.CreateSpinner("+list+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Spn(ret); else return null; }		
	/*#app*/ this._265 = function( width,height,options ) { var ret = prompt( "#", "App.CreateSeekBar("+width+"\f"+height+"\f"+options ); if( ret ) return new Skb(ret); else return null; }		
	/*#app*/ this._266 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateText("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txt(ret); else return null; }		
	/*#app*/ this._267 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateTextEdit("+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Txe(ret); else return null; }		
	/*#app*/ this._268 = function( list,width,height,options,delim ) { var ret = prompt( "#", "App.CreateList(\f"+list+"\f"+width+"\f"+height+"\f"+options+"\f"+delim ); if( ret ) return new Lst(ret); else return null; }	
	/*#app*/ this._269 = function( width,height,options,zoom ) { var ret = prompt( "#", "App.CreateWeb(\f"+width+"\f"+height+"\f"+options+"\f"+zoom ); if( ret ) return new Web(ret); else return null; }	
	/*#app*/ this._270 = function( width,height,options ) { var ret = prompt( "#", "App.CreateScroller("+width+"\f"+height+"\f"+options ); if( ret ) return new Scr(ret); else return null; }	
	/*#app*/ this._271 = function( width,height,options ) { var ret = prompt( "#", "App.CreateCameraView("+width+"\f"+height+"\f"+options );  if( ret ) return new Cam(ret); else return null; }	
	/*#app*/ this._272 = function( width,height,options ) { var ret = prompt( "#", "App.CreateVideoView(\f"+width+"\f"+height+"\f"+options );  if( ret ) return new Vid(ret); else return null; }	
	/*#app*/ this._273 = function( text,width,height,options ) { var ret = prompt( "#", "App.CreateCodeEdit(\f"+text+"\f"+width+"\f"+height+"\f"+options ); if( ret ) return new Cde(ret); else return null; }		
	...
	/*#app*/ this._274 = function( baseTheme ) { var ret = prompt( "#", "App.CreateTheme(\f"+baseTheme ); if( ret ) return new Thm(ret); else return null;  }		
	
	//These objects auto-release (ie. single instance)
	/*#app*/ this._275 = function( msg,options ) { if( _ynd ) _ynd.Release(); var ret = prompt( "#", "App.CreateYesNoDialog(\f"+msg+"\f"+options ); if( ret ) _ynd = new Ynd(ret); else _ynd = null; return _ynd; }		
	/*#app*/ this._276 = function( title,list,options ) { if( _ldg ) _ldg.Release(); var ret = prompt( "#", "App.CreateListDialog(\f"+title+"\f"+list+"\f"+options ); if( ret ) _ldg = new Ldg(ret); else _ldg = null; return _ldg; }	
	...
	/*#app*/ this._277 = function( filter ) { if( _btl ) _btl.Release(); var ret = prompt( "#", "App.CreateBluetoothList("+filter ); if( ret) _btl = new Btl(ret); else _btl = null; return _btl; }	
	/*#app*/ this._278 = function() { if( _rec ) _rec.Release(); var ret = prompt( "#", "App.CreateAudioRecorder(" ); if( ret) _rec = new Rec(ret); else _rec = null; return _rec; }
	/*#app*/ this._279 = function() { if( _sms ) _sms.Release(); var ret = prompt( "#", "App.CreateSMS(" ); if( ret) _sms = new SMS(ret); else _sms = null; return _sms; }
	/*#app*/ this._280 = function( account,password ) { if( _eml ) _eml.Release(); var ret = prompt( "#", "App.CreateEmail("+account+"\f"+password ); if( ret) _eml = new EMAIL(ret); else _eml = null; return _eml; }
	/*#app*/ this._281 = function( type ) { if( _smw ) _smw.Release(); var ret = prompt( "#", "App.CreateSmartWatch(\f"+type ); if( ret) _smw = new SMW(ret); else _smw = null; return _smw; }
	/*#app*/ this._282 = function( options ) { if( _crp ) _crp.Release(); var ret = prompt( "#", "App.CreateCrypt(\f"+options ); if( ret) _crp = new Crp(ret); else _crp = null; return _crp; }
	/*#app*/ this._283 = function( options ) { if( _spr ) _spr.Release(); var ret = prompt( "#", "App.CreateSpeechRec(\f"+options ); if( ret) _spr = new Spr(ret); else _spr = null; return _spr; }
	/*#app*/ this._284 = function( types ) { if( _pst ) _pst.Release(); var ret = prompt( "#", "App.CreatePhoneState(\f"+types ); if( ret) _pst = new Pst(ret); else _pst = null; return _pst; }
	/*#app*/ this._285 = function( options ) { if( _wpr ) _wpr.Release(); var ret = prompt( "#", "App.CreateWallpaper(\f"+options ); if( ret) _wpr = new Wpr(ret); else _wpr = null; return _wpr; }
	
	//These objects need releasing manually.
	/*#app*/ this._286 = function( title,options ) { var ret = prompt( "#", "App.CreateDialog(\f"+title+"\f"+options ); if( ret ) return new Dlg(ret); else return null; }		
	/*#app*/ this._287 = function( options ) { var ret = prompt( "#", "App.CreateOverlay(\f"+options ); if( ret ) return new Ovl(ret); else return null; }		
	/*#app*/ this._288 = function() { var ret = prompt( "#", "App.CreateMediaPlayer(" ); if( ret ) return new Aud(ret); else return null; }
	/*#app*/ this._289 = function( type,options ) { var ret = prompt( "#", "App.CreateSensor("+type+"\f"+options ); if( ret ) return new Sns(ret); else return null; }		
	/*#app*/ this._290 = function( type,options ) { var ret = prompt( "#", "App.CreateLocator("+type+"\f"+options ); if( ret ) return new Loc(ret); else return null; }		
	/*#app*/ this._291 = function( type ) { var ret = prompt( "#", "App.CreateNetClient("+type ); if( ret ) return new Net(ret); else return null; }
	/*#app*/ this._292 = function() { var ret = prompt( "#", "App.CreateNxtRemote(" ); if( ret ) return new Nxt(ret,null); else return null; }	
	/*#app*/ this._293 = function( port,options ) { var ret = prompt( "#", "App.CreateWebServer("+port+"\f"+options ); if( ret ) return new Wbs(ret); else return null; }	
	/*#app*/ this._294 = function( baudRate,dataBits,stopBits,parity,device ) { var ret = prompt( "#", "App.CreateUSBSerial(\f"+baudRate+"\f"+dataBits+"\f"+stopBits+"\f"+parity+"\f"+device ); if( ret ) return new Usb(ret); else return null; }	
	/*#app*/ this._295 = function( cmd,env,dir,options ) { var ret = prompt( "#", "App.CreateSysProc(\f"+cmd+"\f"+env+"\f"+dir+"\f"+options ); if( ret ) return new Sys(ret); else return null; }	
	/*#app*/ this._296 = function( packageName,className,callback,options ) { var ret = prompt( "#", "App.CreateService(\f"+packageName+"\f"+className+"\f"+options+"\f"+_Cbm(callback) ); if( ret ) return new Svc(ret); else return null; }	
	/*#app*/ this._297 = function( type ) { var ret = prompt( "#", "App.CreateSynth("+type ); if( ret ) return new Syn(ret); else return null; }	
	/*#app*/ this._298 = function( mode ) { var ret = prompt( "#", "App.CreateBluetoothSerial(\f"+mode ); if( ret ) return new Bts(ret); else return null; }	
	/*#app*/ this._299 = function( mode ) { var ret = prompt( "#", "App.CreateZipUtil(\f"+mode ); if( ret ) return new Zip(ret); else return null; }	
	/*#app*/ this._300 = function( options ) { var ret = prompt( "#", "App.CreateDownloader(\f"+options ); if( ret ) return new Dwn(ret); else return null; }	
	/*#app*/ this._301 = function() { var ret = prompt( "#", "App.CreateMediaStore(" ); if( ret ) return new Med(ret); else return null; }	
	/*#app*/ this._302 = function() { var ret = prompt( "#", "App.CreatePlayStore(" ); if( ret ) return new Ply(ret); else return null; }	
	/*#app*/ this._303 = function( options ) { var ret = prompt( "#", "App.CreateNotification(\f"+options ); if( ret ) return new Not(ret); else return null; }	
	/*#app*/ this._304 = function( file,mode ) { var ret = prompt( "#", "App.CreateFile(\f"+file+"\f"+mode ); if( ret ) return new Fil(ret); else return null; }	
	
	//Special methods.
	this._305 = function() { if(typeof OnStart=='function') { OnStart(); prompt("#","_Start"); _started=true; } }
	
	/*#app*/ this._306 = function( name, type ) 
	{ 
	...
	/*#app*/ this._307 = function( cmd )
	{
		try {
			var dbg = _dbg; _UseDbg( false );
			if( app._191("/Sys/ga.js") ) 
			{
				if( cmd.toLowerCase()=='create' ) {
					_LoadScriptSync( "/Sys/ga.js" );
					window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;
					ga('create', arguments[1], {'storage':'none', 'clientId':app._47()});
	...
	/*#app*/ this._308 = function( callback,fps )
	{
		_cbAnimate = callback;
	...
	/*#app*/ this._309 = function(name) { 
		if( name ) return _languages.codes[name.toLowerCase()]; 
		else return _curLang; 
	}

	/*#app*/ this._310 = function( name ) { 
		var json = app._200( "lang.json" )
		_languages = JSON.parse(json);
		_curLang = _languages.codes[name.toLowerCase()];
	}

	//Helper classes.
	/*#app*/ this._311 = function() { var nxtHelp = new _NxtHelp(); return nxtHelp.nxt_CreateNxt(); }
	/*#app*/ this._312 = function( list,width,height,options ) { return new _Tabs( list,width,height,options ); }
	/*#app*/ this._313 = function( id,ip,port,options ) { return new _WebSock( id,ip,port,options ); }
	/*#app*/ this._314 = function( title,width,height,callback,options ) { return new _Wizard( title,width,height,callback,options ) }
	/*#app*/ this._315 = function( file,orient ) { return new _Game( file,orient ) }
	
	//Externally defined methods.
	/*#app*/ this._316 = function( title,deflt,callback ) { _ShowTextDialog( title,deflt,callback ) }
	/*#app*/ this._317 = function( title,list,callback,width,height,options ) { return new _CheckList( title,list,callback,width,height,options ); }
	/*#app*/ this._318 = function( msg,left,top,timeOut,options ) { _ShowTip( msg,left,top,timeOut,options ) }
	/*#app*/ this._319 = function( file ) { _PlaySound( file ) }
	/*#app*/ this._320 = function( title1,title2,callback,options,extra ) { var wifi = new _WifiScan( title1,title2,callback,options,extra ); wifi.Select(); }
	
	//Hybrid objects.
	/*#app*/ this._321 = function( width,height,options ) 
	{ 
	    ...
	    if( options.indexOf("gles")>-1 ) {
			...
			var obj = app._269( width,height,"gameview" );
	...
	/*#app*/ this._322 = function( width,height,options ) 
	{
	    var glv = null;
	    if( options.toLowerCase().indexOf("fast2d") > -1 )
	    {
    		...
    		glv.width = Math.round(app._136()*width);
    		glv.height = Math.round(app._137()*height);
...
function Obj( id )
{
    ...
    /*#obj*/ this._308 = function( type,callback,time ) { prompt( this.id, "Obj.Animate(\f"+type+"\f"+_Cbm(callback)+"\f"+time ); }
}
...
{       
	...
	if( game ) { app._315(); prompt("#","_Start"); _started=true; }
...
function _Log( msg ) { app._99( msg ); }
function _Err( msg ) { app._99( "ERROR: " + msg ); }
